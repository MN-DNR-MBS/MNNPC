...
# External Objects --------------------------------------------------------
mnnpc_vc_systems_named <- c("Acid Peatland (AP)" = "AP",
                            ...
                            "Wet Prarie (WP)" = "WP")
usethis::use_data(mnnpc_vc_systems_named, internal = FALSE, overwrite = TRUE, compress = "xz")

mnnpc_vc_systems <- unname(mnnpc_vc_systems_named)
usethis::use_data(mnnpc_vc_systems, internal = FALSE, overwrite = TRUE, compress = "xz")

mnnpc_vc_systems_flreg_named <- c("Acid Peatland, Northern (APn)" = "APn",
...
usethis::use_data(mnnpc_vc_systems_flreg_named, internal = FALSE, overwrite = TRUE, compress = "xz")

mnnpc_vc_systems_flreg <- unname(mnnpc_vc_systems_flreg_named)
usethis::use_data(mnnpc_vc_systems_flreg, internal = FALSE, overwrite = TRUE, compress = "xz")

mnnpc_vc_systems_flreg_nested <- list("AP" = c("AP", "APn"),
                                     ...
                                     "WPn" = "WPn",
                                     "WPs" = "WPs")
usethis::use_data(mnnpc_vc_systems_flreg_nested, internal = FALSE, overwrite = TRUE, compress = "xz")
