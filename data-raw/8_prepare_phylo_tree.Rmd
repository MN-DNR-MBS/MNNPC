...
mnnpc_phylo_taxa_lookup <- mnnpc_accepted_taxa |>
  dplyr::mutate("search_name" = stringr::str_remove_all(string = taxon_name, pattern = strings_to_remove))
...
usethis::use_data(mnnpc_phylo_tree, internal = FALSE, overwrite = TRUE, compress = "xz")
usethis::use_data(mnnpc_phylo_taxa_lookup, internal = FALSE, overwrite = TRUE, compress = "xz")
```
